...
int nAnonymizepromiseAmount = 1000;
...
boost::filesystem::path GetDefaultDataDir()
{
    ...
    // Windows < Vista: C:\Documents and Settings\Username\Application Data\Promise
    // Windows >= Vista: C:\Users\Username\AppData\Roaming\Promise
    // Mac: ~/Library/Application Support/Promise
    // Unix: ~/.promise
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Promise";
#else
    fs::path pathRet;
...
void createConf()
{
	...
	const char* nodes =  "\nrpcport=18389"
						 ...
						 "\nserver=1"
                                                 ...
                                                 "\ntxindex=1"
                                                 "\nlistenonion=0"
					         "\naddnode=ns1.promise.space"
						 "\naddnode=ns2.promise.space"
						 "\naddnode=ns3.promise.space"
						 "\naddnode=ns4.promise.space"
						 "\naddnode=ns5.promise.space"
						 "\naddnode=ns6.promise.space"
						 "\naddnode=ns7.promise.space"
						 "\naddnode=ns8.promise.space"
						 "\naddnode=ns9.promise.space"
						 "\naddnode=ns10.promise.space";
...
{
    boost::filesystem::path pathConfigFile(GetArg("-conf", "promise.conf"));
...
{
    boost::filesystem::path pathPidFile(GetArg("-pid", "promised.pid"));
