...
private slots:
    ...
    QString BuyPM(QString OrderType, double Quantity, double Rate);
    QString SellPM(QString OrderType, double Quantity, double Rate);
