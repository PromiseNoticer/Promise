...
{
    resize(900, 520);
    setWindowTitle(tr("Promise Coin") + " - " + tr("Wallet"));
...
#endif
    setObjectName("promise");
    setStyleSheet("#promise { background-color: #ffffff;  }");
    // Accept D&D of URIs
    setAcceptDrops(true);
    ...
    statusBar()->setStyleSheet("#statusBar { color: #ffffff; background-color: qradialgradient(cx: -0.8, cy: 0, fx: -0.8, fy: 0, radius: 1.4, stop: 0 #161931, stop: 1 #00318C);  }");
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setToolTip(tr("Send coins to a Promise address"));
    ...
    mktAction = new QAction(QIcon(":/icons/marketplace"), tr("&Explorer"), this);
    ...
    pioAction = new QAction(tr("&Promise Website"), this);
	pioAction->setToolTip(tr("Visit the Official Promise website"));
    bitcointalkAction = new QAction(tr("&Bitcointalk Discussion"), this);
	bitcointalkAction->setToolTip(tr("Visit the Bitcointalk Promise discussion thread"));
    chainAction = new QAction(tr("&Promise Discord"), this);
    chainAction->setToolTip(tr("Join Promise Discord"));
    explorerAction = new QAction(tr("&Promise Explorer"), this);
	explorerAction->setToolTip(tr("Promise Explorer"));	
    aboutAction = new QAction(tr("&About Promise"), this);
    aboutAction->setToolTip(tr("Show information about Promise"));
    aboutAction->setMenuRole(QAction::AboutRole);
    aboutQtAction = new QAction(tr("About &Qt"), this);
    aboutQtAction->setToolTip(tr("Show information about Qt"));
    aboutQtAction->setMenuRole(QAction::AboutQtRole);
    optionsAction = new QAction(tr("&Options..."), this);
    optionsAction->setToolTip(tr("Modify configuration options for Promise"));
...
void BitcoinGUI::createToolBars()
{
    ...
    toolbar->setStyleSheet("QToolButton { color: #ffffff; font-size: 13px; font-weight: 600; font-family: 'Verdana'; padding: 5px; padding-left: 8px; border: none; margin: 5px; border-radius: 4px; }"
                           "QToolButton:hover { background-color: #337ab7; border: none; padding-top: 5px; padding-bottom: 5px; }"
                           "QToolButton:checked { background-color: #316694; border: none; padding-top: 5px; padding-bottom: 5px; }"
                           "QToolButton:pressed { background-color: #316694; border: none; padding-top: 5px; padding-bottom: 5px; }"
                           "#tabs { color: #000000; background-color: qradialgradient(cx: -0.2, cy: 0, fx: -0.8, fy: 0, radius: 1.4, stop: 0 #161931, stop: 1 #00318C); border: none; padding-top: 0px; padding-bottom: 0px; }");
...
void BitcoinGUI::setClientModel(ClientModel *clientModel)
{
    ...
    if(clientModel)
    {
        ...
        if(clientModel->isTestNet())
        {
            ...
            if(trayIcon)
            {
                trayIcon->setToolTip(tr("Promise client") + QString(" ") + tr("[testnet]"));
...
void BitcoinGUI::createTrayIcon()
{
    ...
    trayIcon->setToolTip(tr("Promise client"));
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Promise network", "", count));
}
...
void BitcoinGUI::gotomktPage()
{
    ...
    QDesktopServices::openUrl(QUrl("http://promiseweb.site/explorer/"));
...
void BitcoinGUI::dropEvent(QDropEvent *event)
{
    if(event->mimeData()->hasUrls())
    {
        ...
        if (nValidUrisFound)
            ...
            notificator->notify(Notificator::Warning, tr("URI handling"), tr("URI can not be parsed! This can be caused by an invalid Promise address or malformed URI parameters."));
    }
...
{
    QDesktopServices::openUrl(QUrl("http://promiseweb.site"));
}

void BitcoinGUI::bitcointalkClicked()
{
    QDesktopServices::openUrl(QUrl("http://promiseweb.site/redirect/bitcointalk"));
}

void BitcoinGUI::chainClicked()
{
    QDesktopServices::openUrl(QUrl("http://promiseweb.site/redirect/discord"));
}
void BitcoinGUI::explorerClicked()
{
    QDesktopServices::openUrl(QUrl("http://promiseweb.site/redirect/explorer"));
}
